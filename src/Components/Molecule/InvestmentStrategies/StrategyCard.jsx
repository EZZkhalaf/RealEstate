...
const StrategyCard = ({ strategy }) => {
  ...
  // },
  return (
    <div className="flex flex-col gap-2 rounded-lg   shadow-2xl py-2 px-5 ">
      ...
      <div className="grid w-full grid-cols-2 gap-4 mb-6">
        <div className="">
          <p className="text-sm font-medium text-gray-800 mb-1">Timeframe</p>
        ...
        <div className="flex flex-col items-start">
          <p className="text-sm font-medium text-gray-800 mb-1">Risk Level</p>
          <p className="text-xs text-gray-800 bg-gray-200 py-1 px-2 rounded-lg  ">
            {strategy.riskLevel}
          </p>
        </div>
      </div>
